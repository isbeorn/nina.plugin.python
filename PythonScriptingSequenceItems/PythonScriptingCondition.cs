...
namespace NINA.Plugin.Python.PythonScriptingTestCategory {
    ...
    public class PythonScriptingCondition : SequenceCondition {
        /// <summary>
        ...
        public override object Clone() {
            return new PythonScriptingCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(PythonScriptingCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}